...
if you can boost its signal strength high enough; there's a little meter that
...
a sonar sweep of the nearby sea floor. On a small screen, the sonar sweep
report (your puzzle input) appears: each line is a measurement of the sea floor
